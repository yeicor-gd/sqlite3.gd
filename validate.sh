...
_extract_runtime_errors() {
    ...
    grep -A 1 -E "^ERROR:|^SCRIPT ERROR:|^WARNING:|Shader compilation error|Script compilation error|Parse error|undefined method|undefined symbol|not found|No such" || return 0
}
